...
export enum Constants {
  BRANDNAME = 'Tools n Tuts Kids',
  CREDENTIAL = 'credential',
  GOOGLE = 'google',
  AFTERAUTH = '/dashboard',
  SUPPORTEMAIL = 'support@children.toolsntuts.com',
  BRANDWEBSITE = 'https://children.toolsntuts.com',
}
...
export const SiteMeta = {
  title: 'Tools n Tuts Kids',
  description:
    'A new true-to-life illustrated story every day — grounded in real, researched Nigerian life, drawing its heart from Scripture, pointing to Jesus.',
  keywords: [
    'Christian comic',
    'Bible stories',
    'daily devotional',
